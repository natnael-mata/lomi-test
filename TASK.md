...
**150 of 188 tasks done.** Generated by `node scripts/task-progress.mjs` —
do not edit by hand.
...
| Phase 5 — Student core: practice                 | 15/16 | 94%  | 1 left      |
...
## Phase 5 — Student core: practice — 1 left
...
- [ ] **T-111a** Point `SUBSCRIPTION_ACCESS` at the real `Subscription` when `phase-8-payments`
