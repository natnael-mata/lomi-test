...
**116 of 187 tasks done.** Generated by `node scripts/task-progress.mjs` —
do not edit by hand.
...
| Phase 3 — Auth & accounts                        | 9/13  | 69%  | blocked · 4 left |
...
- [ ] **T-112a** Move the session token out of `localStorage` into an httpOnly cookie set by the
      ...
      **Depends on T-077**, which sets the cookie — owned by the project owner.
