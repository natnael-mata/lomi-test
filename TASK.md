...
**145 of 188 tasks done.** Generated by `node scripts/task-progress.mjs` —
do not edit by hand.
...
| Phase 12 — Hardening & launch                    | 6/16  | 38%  | 10 left     |
...
## Phase 12 — Hardening & launch — 10 left
...
- [ ] **T-199b** Audit the dev-only scripts before launch: `dev:session` and `dev:publish` mint
...
- [ ] **T-199c** Decide whether the web and API should share a types package.
