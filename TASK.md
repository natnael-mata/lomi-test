...
**122 of 188 tasks done.** Generated by `node scripts/task-progress.mjs` —
do not edit by hand.
...
| Phase 5 — Student core: practice                 | 14/16 | 88%  | 2 left      |
...
## Phase 5 — Student core: practice — 2 left
...
- [ ] **T-112a** Move the session token out of `localStorage` into an httpOnly cookie set by the
